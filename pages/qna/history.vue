...
.icon-btn { width: 64rpx; height: 64rpx; border-radius: 32rpx; background: #f7f7f7; color: #ff7aa0; font-size: 28rpx; display: flex; align-items: center; justify-content: center; }

.divider-row { margin: 12rpx 24rpx; display: flex; align-items: center; gap: 16rpx; }
.divider { flex: 1; height: 2rpx; background: #f0f0f0; }
.heart { color: #ff7aa0; font-size: 26rpx; }

.list { padding: 12rpx 24rpx; }
.list-item { display: flex; align-items: center; padding: 18rpx 0; border-bottom: 1rpx solid #f5f5f5; }
.list-item:last-child { border-bottom: none; }
.left { width: 64rpx; }
.index { font-size: 30rpx; color: #ff7aa0; font-weight: 700; }
.center { flex: 1; }
.question { font-size: 28rpx; color: #2b2b2b; }
.right { width: 60rpx; display: flex; justify-content: flex-end; }
.status { width: 32rpx; height: 32rpx; border-radius: 16rpx; border: 3rpx solid #ffc1d1; }
.status.done { background: #ffc1d1; }
