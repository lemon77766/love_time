<template>
  <view class="xinxiang-page" :style="{ paddingTop: containerPaddingTop }">
    ...
    <!-- 背景图片铺满整个屏幕 -->
    <image class="background-image" src="/subPackages/record/static/xinxiang/1.jpg" mode="aspectFill"></image>
...
export default {
  ...
  methods: {
    ...
    openHistory() {
      uni.navigateTo({ url: '/subPackages/record/pages/xinxiang/history' });
    },
    openReceived() {
      uni.navigateTo({ url: '/subPackages/record/pages/xinxiang/received' });
    },
    createLetter() {
