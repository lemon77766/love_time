...
const _sfc_main = {
  ...
  methods: {
    ...
    openHistory() {
      common_vendor.index.navigateTo({ url: "/subPackages/record/pages/xinxiang/history" });
    },
    openReceived() {
      common_vendor.index.navigateTo({ url: "/subPackages/record/pages/xinxiang/received" });
    },
    createLetter() {
...
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/subPackages/record/pages/xinxiang/index.js.map
