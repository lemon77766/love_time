  ...
  methods: {
    ...
    async loadLetters() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/xinxiang/received.vue:192", "加载收到的信件失败", error);
        this.letters = [];
    ...
    async viewLetter(letter, index) {
      try {
        ...
        common_vendor.index.hideLoading();
        common_vendor.index.__f__("error", "at pages/xinxiang/received.vue:266", "获取信件详情失败", error);
        this.currentLetter = letter;
        this.currentIndex = index;
        this.showDetailModal = true;
        common_vendor.index.showToast({
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/xinxiang/received.js.map
